...
vim.keymap.set('n', ';f', require('fzf-lua').files, { desc = '[S]earch [F]iles' })
...
vim.keymap.set('v', '<leader>sw', require('fzf-lua').grep_visual, { desc = '[S]earch current [W]ord' })
vim.keymap.set('n', ';sg', require('fzf-lua').live_grep, { desc = '[S]earch by [G]rep' })
vim.keymap.set('n', ';sd', require('fzf-lua').diagnostics_workspace, { desc = '[S]earch [D]iagnostics' })
